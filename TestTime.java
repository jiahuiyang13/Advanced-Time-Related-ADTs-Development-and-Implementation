...
public class TestTime extends LockedTestCase {
	...
	private static Calendar lectureStart() {
		...
		cal.set(2022, Calendar.SEPTEMBER, 6, 9, 30, 0);
    ...
    public void test() {
    	...
    	Time t = new Time(cal);
    	String firstLectureDay = Ts(35476209); // first lecture day in yyyy/mm/dd format
    	String firstLectureTime = Ts(255111569); // first lecture time in hh:mm format (Greenwich mean time!)
    	assertEquals("UTC AD " + firstLectureDay + " " + firstLectureTime + ":00",t.toString());
    	
    	Time t2 = t.add(Duration.DAY);
    	assertEquals(Ts(817479373),t2.toString()); // don't forget seconds: ":00"

    	Time t3 = t2.subtract(Duration.MINUTE);
    	assertEquals(Ts(2122929257),t3.toString()); // don't forget seconds: ":00"
	...
	public void test23() {
		...
		cal.set(Calendar.MINUTE, 1);
		Time t2 = new Time(cal);
		assertPositive("start ? earlier",t1.compareTo(t2));
    }
	...
	public void test31() {
		Calendar cal = lectureStart();
		Time t1 = new Time(cal);
		assertEquals("UTC AD 2022/09/06 14:30:00",t1.toString());
	}
	...
	public void test32() {
		...
		// held on the topic of Data structures at 9:30am.
		// And apparently during the iron age, there was no daylight saving time.
		// during that 3000 years transition.
		Time t1 = new Time(cal);
		assertEquals("UTC BC 0979/09/06 15:30:00",t1.toString());
	}
	...
	public void test53() {
		...
		assertEquals("UTC AD 2022/09/07 14:30:00",t2.toString());
	}
	...
	public void test54() {
		...
		assertEquals("UTC AD 2026/09/06 14:30:00",t2.toString());
	}
